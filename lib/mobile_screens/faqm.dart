...
import 'package:ss_hospitals/screens/FAQ.dart';
...
class FAQM extends StatefulWidget {
  @override
  _FAQMState createState() => _FAQMState();
}

class _FAQMState extends State<FAQM> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
              ...
              child: Container(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    FAQqbarM(text: "Why should Autism be treated?"),
                    SizedBox(
                      height: 20.0,
                    ),
                    FAQabarM(
                    ...
                    FAQqbarM(
                        text:
                            "Will DBS alone help my child come out of Autism?"),
                    SizedBox(
                      height: 20.0,
                    ),
                    FAQabarM(
                    ...
                    FAQqbarM(text: "Is Parkinson’s a Curable Disease?"),
                    SizedBox(
                      height: 20,
                    ),
                    FAQabarM(
