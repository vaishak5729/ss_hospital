...
import 'package:ss_hospitals/screens/specialities.dart';
...
class SpecialitiesM extends StatefulWidget {
  @override
  _SpecialitiesMState createState() => _SpecialitiesMState();
}

class _SpecialitiesMState extends State<SpecialitiesM> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
